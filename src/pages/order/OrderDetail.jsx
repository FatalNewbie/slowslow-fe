...
const OrderDetail = () => {
  ...
  if (error) {
    return <Typography variant="h6" color="error">오류가 발생했습니다: {error.message}</Typography>;
  }
  ...
  return (
    <Container maxWidth="md">
      ...
      >
        ...
        >
          <Typography variant="h6" mb={2}>주문 정보 수정</Typography>
          <Divider sx={{ mb: 2 }} />
          <Typography variant="subtitle1" mb={2}>주문자 정보</Typography>
          <TextField
            fullWidth
            label="이름"
            name="orderName"
          ...
          <TextField
            ...
            sx={{ mb: 2 }}
          />
          <Typography variant="subtitle1" mb={2}>배송지 정보</Typography>
          <TextField
            fullWidth
            label="이름"
            name="shipName"
