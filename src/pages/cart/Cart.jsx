    ...
    await Promise.all(
      ...
      carts.map(async (cart) => {
        if (cart.checked === true) {
          ...
          totalAmount =
            totalAmount + productFromBE.price * Number(cart.productCnt);
        }
      })
    );
            ...
            <Grid xs={8}>
              <Box>
                <Grid container spacing={2}>
                  ...
                  <Grid xs={2}>
                    <Box>
                      <Button onClick={DeleteSelectionBtnHandler}>
                        선택삭제
                      </Button>
                    </Box>
                  </Grid>
            ...
            <Grid xs={4}>
              <Item>
                <Grid container spacing={2}>
                  ...
                  <Grid xs={6}>
                    <Box>{totalProductAmount.toLocaleString("ko-KR")} 원</Box>
                  </Grid>
                  <Grid xs={6}>
                    <Box>총 배송비</Box>
                  </Grid>
                  <Grid xs={6}>
                    <Box>{deliveryFee.toLocaleString("ko-KR")} 원</Box>
                  </Grid>
                </Grid>
                <hr />
                <Grid xs={12}>
                ...
                <Grid xs={12}>
                  <Box>
                    <Button onClick={purchaseBtnhandler}>구매하기</Button>
                  </Box>
                </Grid>
              </Item>
            </Grid>
